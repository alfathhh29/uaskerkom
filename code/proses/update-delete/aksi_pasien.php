        ...
        <form action="code/proses/update-delete/update/update_pasien.php" method="POST">
            ...
            <table id="tabel-pendaftaran">
                ...
                ?>
                    ...
                    <tr>
                        <td><b>Registation Code</b></td>
                    </tr>
                    <tr>
                        <td><input type="text" name="" size="25px" maxlength="40" placeholder="ketikkan nama pasien..." value="<?php echo $isi['NamaPasien']; ?>" required></td>
                    </tr>
                    ...
                    <tr>
                        <td><textarea name="NamaPasien" cols="28" rows="5" maxlength="50" placeholder="ketikkan alamat pasien.." required><?php echo $isi['NamaPasien']; ?></textarea></td>
                    </tr>
