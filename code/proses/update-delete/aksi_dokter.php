        ...
        <form action="code/proses/update-delete/update/update_dokter.php" method="POST">
            ...
            <table id="tabel-pendaftaran">
                ...
                ?>
                    ...
                    <tr>
                        <td><input type="text" name="Spesialis" size="25px" maxlength="30" placeholder="ketikkan No Registrasi..." value="<?php echo $isi['Spesialis']; ?>" required></td>
                    </tr>
