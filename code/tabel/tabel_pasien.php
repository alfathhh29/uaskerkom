...
<table id="daftar-table" border='0' bordercolor="black" cellpading='2' cellspacing='2' width='100%'>
	<tr align='center'>
		...
		<th class="normal">Registration Code</th>
	...
	if (isset($_POST['cari']) and $_POST['cari'] <> "") {
		...
		$tampilkan_isi = "SELECT * FROM pasien INNER JOIN dokter WHERE pasien.KodeDokter=dokter.KodeDokter";
	}
	...
	while ($isi = mysqli_fetch_array($tampilkan_isi_sql)) {
		...
		$AlamatPasien = $isi['no_registrasi'];
		$GenderPasien = $isi['GenderPasien'];
		$UmurPasien = $isi['UmurPasien'];
		$TeleponPasien = $isi['policlinic'];
		$NamaDokter = $isi['dokter_id'];
	?>
